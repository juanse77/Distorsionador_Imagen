...
<li>La imagen de salida presenta una alteración en los valores de los canales verde y azul. El canal rojo no se altera en este efecto. Los canales verde y azul incrementarán los valores de sus píxeles en un rango aleatorio entre 64 y 96. Si cualquiera de estos valores supera el máximo de 255 se le aplicará el módulo.</li>
